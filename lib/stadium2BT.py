...
"""Define stadium2 zone for BT. For testing, different only in name from stadium."""
...
class zoneSignal(threading.Thread):
   ...
   def __init__(self, zoneObj, stoprequest, GPScon, t):
      ...
      logging.info('stadium2.zoneSignal initialized.')

   def run(self):
      logging.info('stadium2.zoneSignal started.')
      ...
      logging.info('Exiting stadium2.zoneSignal thread, for new course update or shutdown')
